...
ingredients = pd.DataFrame(
                  [{'kg/L': 2.72/13.2, 'in_mix' : 0.929444,   'N' : .3,  'P' : .45, 'K' : .05,  "Ca" : 1},
...
def composition(volume=18, units="L", df=ingredients):
    "input volume and mix ratio to get the nutrient composition of a mix."
    # for row in df:
    # weight = volume * density * in_mix
    # weight * ingredients[["N", "P", "K", "Ca", "Mg", "S", "Fe"]] 
